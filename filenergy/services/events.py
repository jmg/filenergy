...
USER_DIGEST_SENT = "user.digest_sent"
WEBAUTHN_REGISTERED = "user.webauthn_registered"
WEBAUTHN_REMOVED = "user.webauthn_removed"
WEBAUTHN_VERIFIED = "user.webauthn_verified"
